...
import com.Library.helper.Message;
...
public class HomeController {
	...
	public String messagesSend(@RequestParam("fname") String fname, @RequestParam("lname") String lname,
			@RequestParam("email") String email, @RequestParam("contact") String contact,
			@RequestParam("message") String message, HttpSession session, Model model) {
		try {
			...
			session.setAttribute("message", new Message("Message Send Succesfully !!", "alert-success"));
	...
	public String new_Password(@RequestParam("password") String password,
